<template>
  <main
    class="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white min-h-screen flex flex-col"
  >
    <!-- Top Navigation Bar -->
    <header
      ...
      <form class="space-y-6" @submit.prevent>
        ...
        <div class="flex flex-col space-y-2">
          ...
          <input
            v-model="store.name"
            type="text"
            placeholder="e.g. Neon Horizon Crafts"
            class="w-full h-14 px-4 rounded-xl text-white placeholder:text-slate-500
        ...
        <div class="flex flex-col space-y-2">
          ...
          <div class="relative flex items-center">
            ...
            <input
              ...
              type="text"
              placeholder="handle"
              class="w-full h-14 pl-10 pr-12 rounded-xl text-white placeholder:text-slate-500
                     border border-slate-600 focus:border-primary
                     focus:ring-1 focus:ring-primary outline-none"
            />
        ...
        <div class="flex flex-col space-y-2">
          ...
          <div
            class="flex overflow-x-auto gap-3 pb-2 no-scrollbar -mx-1 px-1"
          >
            <button
              ...
              class="whitespace-nowrap px-5 py-2.5 rounded-full text-sm font-medium
                     border transition-all"
              :class="store.type === type
        ...
        <div class="flex flex-col space-y-2">
          ...
          <textarea
            ...
            rows="4"
            maxlength="160"
            placeholder="Tell your customers what makes your store unique..."
            class="w-full p-4 rounded-xl text-white placeholder:text-slate-500
                   border border-slate-600 focus:border-primary
    ...
    <!-- Bottom Action Area -->
    <div
      class="fixed bottom-0 left-0 right-0 p-6
    ...
    >
      <div class="mx-auto max-w-md">
        ...
        <p
          v-if="error"
          class="text-red-400 text-xs text-center mb-3"
        >
          {{ error }}
        </p>
        ...
        <button
          @click="submit"
          :disabled="loading"
          class="w-full h-16 bg-primary text-black font-extrabold text-lg
...
async function submit() {
  ...
  try {
    ...
    console.log("[CreateStore] Success:", result);
